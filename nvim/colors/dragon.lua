...
local hlgroups = {
  ...
  FloatBorder = { bg = c_dragonBg1, fg = c_dragonFg2 },
  FloatFooter = { bg = c_dragonBg1, fg = c_dragonFg2 },
  FloatTitle = { bg = c_dragonBg1, fg = c_dragonGray2, bold = true },
  ...
  NormalFloat = { bg = c_dragonBg1, fg = c_dragonFg1 },
